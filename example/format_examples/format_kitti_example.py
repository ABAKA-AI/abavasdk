...
# kitti_txt
out_path = "./output"
Export.abava_json2odkitti(source_data=source_data, out_path=out_path, mapping=mapping)

# kitti_label
out_path = "/XXX/XXX/"
Export.abava_json2segkitti(source_data=source_data, out_path=out_path, mapping=mapping)
